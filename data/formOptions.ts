export const countryCodes = [
    ...
    { value: "+1-869", label: "🇰🇳 Saint Kitts (+1-869)" },
    { value: "+1-758", label: "🇱🇨 Saint Lucia (+1-758)" },
    { value: "+590", label: "🇲🇫 Saint Martin (+590)" },
    { value: "+508", label: "🇵🇲 Saint Pierre (+508)" },
    { value: "+1-784", label: "🇻🇨 Saint Vincent (+1-784)" },
    { value: "+685", label: "🇼🇸 Samoa (+685)" },
    { value: "+378", label: "🇸🇲 San Marino (+378)" },
    { value: "+239", label: "🇸🇹 Sao Tome (+239)" },
    ...
    { value: "+1-868", label: "🇹🇹 Trinidad (+1-868)" },
    { value: "+216", label: "🇹🇳 Tunisia (+216)" },
    { value: "+90", label: "🇹🇷 Turkey (+90)" },
    { value: "+993", label: "🇹🇲 Turkmenistan (+993)" },
    { value: "+1-649", label: "🇹🇨 Turks and Caicos (+1-649)" },
