            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1">
                  <select {...register("countryCode", { required: true })} className="input w-full">
                    ...
                    <option value="+400">🇻🇳 Vietnam (+84)</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <select {...register("budget", { required: true })} className="input">
              ...
              <div>
                <select {...register("timeline", { required: true })} className="input">
