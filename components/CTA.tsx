  ...
  return (
    <section className="relative w-full py-[160px] lg:py-[200px] bg-[#0B0B0B] overflow-hidden">
      <div className="w-full max-w-[800px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-8 inline-flex items-center gap-2 px-3 py-1 bg-transparent border border-[#1F1F1F] text-[11px] font-mono text-[#A1A1AA] tracking-[0.1em] uppercase">
          <span className="w-1.5 h-1.5 bg-[#7C3AED]" />
          Initialize System
        </div>

        <h2 className="text-[48px] md:text-[64px] font-bold text-white leading-[1.05] tracking-tight mb-6">
           Deploy Scalable Architecture <span className="text-[#A1A1AA] block mt-2">In Days, Not Quarters.</span>
        </h2>

        <p className="text-[16px] md:text-[18px] text-[#A1A1AA] leading-[1.6] mb-12 max-w-[560px]">
